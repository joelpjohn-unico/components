...
public class JiraWriterTestBase {
    ...
    protected void setupIndexedRecords() {
        ...
        String badProject = Utils.readFile("src/test/resources/org/talend/components/jira/runtime/writer/badProject.json");
        badJsonRecord.put(0, "TP");
        badJsonRecord.put(1, badProject);

        wrongProjectRecord = new ListIndexedRecord(updateSchema);
        String wrongProject = Utils.readFile("src/test/resources/org/talend/components/jira/runtime/writer/updateProject.json");
