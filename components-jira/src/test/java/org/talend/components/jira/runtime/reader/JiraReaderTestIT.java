...
public class JiraReaderTestIT {
    ...
    public void testReadProjects() throws IOException {
        ...
        assertThat(entities.get(0).toString(), containsString("Public Project 1"));
        assertThat(entities.get(1).toString(), containsString("Public Project 2"));
        assertThat(entities.get(2).toString(), containsString("Test Project"));
    }
    ...
    public void testReadIssue() throws IOException {
        ...
        assertThat(entities, hasSize(1));
        assertThat(entities.get(0).toString(), containsString("Test issue 1"));
        assertThat(entities.get(0).toString(), not(startsWith("[")));
    }
    ...
    public void testReadIssues() throws IOException {
        ...
        assertThat(entities, hasSize(2));
        assertThat(entities.get(0).toString(), containsString("Test issue 2"));
        assertThat(entities.get(1).toString(), containsString("Test issue 1"));
    }
